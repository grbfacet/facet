...
In the energy doubling experiment, it was not essential to precisely measure the electrons' energies. In general, development of plasma acceleration technology did not usually require careful attention to exacting measurement standards. Nevertheless, it is helpful to understand the relevant error concepts because they are crucial to the understanding of any study that involves numerical measurements. 
