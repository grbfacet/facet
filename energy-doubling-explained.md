...
We begin with SLAC, formerly known as the Stanford Linear Accelerator Center, today officially known as SLAC National Accelerator Laboratory. This is a large research laboratory with up to 2000 people working on site and many more visiting to do research. SLAC has a five decade history of research projects. It is a complex entity with many buildings, research facilities, and departments to handle things like payroll and personal issues. SLAC is funded by the U.S. Department of Energy (DOE) and the lab is managed by Stanford University under a contract with the Department of Energy. SLAC is located in Menlo Park, California next to Stanford University. 
