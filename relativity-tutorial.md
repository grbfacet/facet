...
<span class="eq">100 GeV/1 GeV = 100 = (v<sub>100</sub>/v<sub>1</sub>)<sup>2</sup> and solving gives</span>
...
To make a noticeable difference in the mass, say to double the inertial mass, we found we needed
